...
public class FileDialogues {
	...
	public static func savePanelModal(for window: NSWindow, message: String, nameFieldLabel: String, nameField: String, currentDirectory: URL? = nil, isExtensionHidden: Bool, allowedFileExtensions: [String]?, completionHandler handler: @escaping SaveCompletionHandler) {
